...
/***/ function(module, exports, __webpack_require__) {
	...
	var _videoPlayer = __webpack_require__(89);

	var _videoPlayer2 = _interopRequireDefault(_videoPlayer);

	var _chatRoom = __webpack_require__(136);
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement('input', { type: 'text', placeholder: 'create a chatroom' }),
	            React.createElement('input', { type: 'submit', value: 'submit' }),
	            React.createElement('input', { type: 'text', placeholder: 'chatrooms' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _duration = __webpack_require__(135);
	      ...
	      return React.createElement(
	        ...
	        React.createElement(_reactPlayer2.default, {
	          ...
	          onReady: function onReady() {
	            return console.log('video is ready');
	          },
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'td',
	                null,
	                React.createElement('input', { type: 'range', min: 0, max: 1, step: 'any', value: volume, onChange: this.setVolume })
	              )
	            ),
	            React.createElement(
	              'tr',
	              ...
	              React.createElement(
	                'td',
	                null,
	                React.createElement('progress', { max: 1, value: played })
	              )
	            )
	          )
	        ),
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'td',
	                null,
	                React.createElement(_duration2.default, { seconds: duration })
	              )
	            ),
	            React.createElement(
	              'tr',
	              ...
	              React.createElement(
	                'td',
	                null,
	                React.createElement(_duration2.default, { seconds: duration * played })
	              )
	            ),
	            React.createElement(
	              'tr',
	              ...
	              React.createElement(
	                'td',
	                null,
	                React.createElement(_duration2.default, { seconds: duration * (1 - played) })
	              )
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _props3 = __webpack_require__(122);

	var _YouTube = __webpack_require__(123);

	var _YouTube2 = _interopRequireDefault(_YouTube);

	var _SoundCloud = __webpack_require__(127);

	var _SoundCloud2 = _interopRequireDefault(_SoundCloud);

	var _Vimeo = __webpack_require__(130);

	var _Vimeo2 = _interopRequireDefault(_Vimeo);

	var _FilePlayer = __webpack_require__(129);

	var _FilePlayer2 = _interopRequireDefault(_FilePlayer);

	var _Streamable = __webpack_require__(133);

	var _Streamable2 = _interopRequireDefault(_Streamable);

	var _Vidme = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadScript = __webpack_require__(124);
	...
	var YouTube = function (_Base) {
	  ...
	  function YouTube() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = YouTube.__proto__ || Object.getPrototypeOf(YouTube)).call.apply(_ref, [this].concat(args))), _this), _this.onStateChange = function (_ref2) {
	      ...
	      var onBuffer = _this$props.onBuffer;
	  ...
	  _createClass(YouTube, [{
	    ...
	    value: function load(url) {
	      ...
	      var youtubeConfig = _props2.youtubeConfig;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _props2 = __webpack_require__(122);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchJsonp = __webpack_require__(128);

	var _fetchJsonp2 = _interopRequireDefault(_fetchJsonp);

	var _FilePlayer2 = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objectAssign = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _users = __webpack_require__(194);
	...
	var chatRoom = function (_React$Component) {
	  (0, _inherits3.default)(chatRoom, _React$Component);

	  function chatRoom(props) {
	    (0, _classCallCheck3.default)(this, chatRoom);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (chatRoom.__proto__ || (0, _getPrototypeOf2.default)(chatRoom)).call(this, props));
	    ...
	    initialize = function initialize(data) {
	      ...
	      _this.setState({ users: users, user: name });
	    };

	    userJoined = function userJoined(data) {
	      ...
	      _this.setState({ users: users, messages: messages });
	    };
	    ...
	    sendHandler = function sendHandler(message) {
	      var messageObject = {
	      ...
	      _this.socket.emit('client:message', messageObject);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(140)('socket.io-client');
	...
	exports.Socket = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseuri = __webpack_require__(139);
	var debug = __webpack_require__(140)('socket.io-client:url');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(144)('socket.io-parser');
	var json = __webpack_require__(147);
	var Emitter = __webpack_require__(150);
	var binary = __webpack_require__(151);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(148)(module), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(140)('socket.io-client:manager');
	var indexOf = __webpack_require__(182);
	var Backoff = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 */
	module.exports.parser = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseuri = __webpack_require__(139);
	var parsejson = __webpack_require__(183);
	var parseqs = __webpack_require__(173);
	...
	Socket.Transport = __webpack_require__(163);
	Socket.transports = __webpack_require__(158);
	Socket.parser = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XHR = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(159);
	var Polling = __webpack_require__(162);
	var Emitter = __webpack_require__(172);
	var inherit = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transport = __webpack_require__(163);
	var parseqs = __webpack_require__(173);
	var parser = __webpack_require__(164);
	var inherit = __webpack_require__(174);
	var yeast = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasBinary = __webpack_require__(166);
	var sliceBuffer = __webpack_require__(167);
	var after = __webpack_require__(168);
	var utf8 = __webpack_require__(169);

	var base64encoder;
	if (global && global.ArrayBuffer) {
	  base64encoder = __webpack_require__(170);
	}
	...
	var Blob = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (typeof window === 'undefined') {
	  try {
	    NodeWebSocket = __webpack_require__(181);
	  } catch (e) { }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(187);
	var bind = __webpack_require__(188);
	var debug = __webpack_require__(140)('socket.io-client:socket');
