...
/***/ function(module, exports, __webpack_require__) {
	...
	var _videoPlayer = __webpack_require__(92);

	var _videoPlayer2 = _interopRequireDefault(_videoPlayer);

	var _sign_in = __webpack_require__(139);

	var _sign_in2 = _interopRequireDefault(_sign_in);

	var _sign_up = __webpack_require__(140);

	var _sign_up2 = _interopRequireDefault(_sign_up);

	var _chatRoom = __webpack_require__(142);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.emitRoomName = function (room) {
	  ...
	  (0, _createClass3.default)(App, [{
	    ...
	    key: 'messageSubmitHandler',
	    value: function messageSubmitHandler(message, username) {
	      console.log('message fired off', message, username);
	      socket.emit('messageSent', { message: message, username: username });
	      this.message.value = '';
	    }
	  }, {
	    key: 'messageReceiveHandler',
	    value: function messageReceiveHandler(message, username) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        this.state.loggedIn ? React.createElement('input', { className: 'logout', type: 'button', value: 'logout', onClick: this.logout }) : null,
	        React.createElement(
	          'button',
	        ...
	        this.state.loggedIn ? React.createElement(
	          ...
	          React.createElement('input', { ref: function ref(input) {
	              _this2.message = input;
	            }, type: 'text', size: '50', placeholder: 'what do you want to say?' }),
	          React.createElement(
	            'button',
	            { onClick: function onClick() {
	                return _this2.messageSubmitHandler(_this2.message.value, _this2.state.username);
	              } },
	            'This is what I want to say!'
	          ),
	          React.createElement(_messages2.default, { messages: this.state.messages })
	        ) : null
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(12)(IteratorPrototype, __webpack_require__(62)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPlayer = __webpack_require__(93);

	var _reactPlayer2 = _interopRequireDefault(_reactPlayer);

	var _duration = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _props3 = __webpack_require__(125);

	var _YouTube = __webpack_require__(126);

	var _YouTube2 = _interopRequireDefault(_YouTube);

	var _SoundCloud = __webpack_require__(130);

	var _SoundCloud2 = _interopRequireDefault(_SoundCloud);

	var _Vimeo = __webpack_require__(133);

	var _Vimeo2 = _interopRequireDefault(_Vimeo);

	var _FilePlayer = __webpack_require__(132);

	var _FilePlayer2 = _interopRequireDefault(_FilePlayer);

	var _Streamable = __webpack_require__(136);

	var _Streamable2 = _interopRequireDefault(_Streamable);

	var _Vidme = __webpack_require__(137);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPureComponent = __webpack_require__(114);
	var ReactClass = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Base2 = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _props2 = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchJsonp = __webpack_require__(131);

	var _fetchJsonp2 = _interopRequireDefault(_fetchJsonp);

	var _FilePlayer2 = __webpack_require__(132);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objectAssign = __webpack_require__(97);
	  ...
	  (0, _createClass3.default)(SignUp, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement('input', { type: 'button', value: 'Sign Up', className: 'sign-up-button', onClick: this.toggleSignUp }),
	        this.state.show ? React.createElement(
	          'form',
	          { id: 'sign-up-dropdown', onSubmit: this.props.signUp },
	          'User Name: ',
	          React.createElement('input', { type: 'text', className: 'sign-up', name: 'username', placeholder: 'BobJones123!', onChange: this.props.handleChange }),
	          'First Name: ',
	          React.createElement('input', { type: 'text', className: 'sign-up', name: 'firstname', placeholder: 'Bob', onChange: this.props.handleChange }),
	          'Last Name: ',
	          React.createElement('input', { type: 'text', className: 'sign-up', name: 'lastname', placeholder: 'Jones', onChange: this.props.handleChange }),
	          'email: ',
	          React.createElement('input', { type: 'text', className: 'sign-up', name: 'email', placeholder: 'bob@whatever.com', onChange: this.props.handleChange }),
	          'Password: ',
	          React.createElement('input', { type: 'password', className: 'sign-up', name: 'password', placeholder: 'regist123', onChange: this.props.handleChange }),
	          React.createElement('input', { type: 'submit', value: 'Submit' })
	        ) : null
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Manager = __webpack_require__(160);
	...
	exports.Manager = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(150)('socket.io-parser');
	var json = __webpack_require__(153);
	var Emitter = __webpack_require__(156);
	var binary = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.enable = enable;
	exports.enabled = enabled;
	exports.humanize = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  var isLoader = "function" === "function" && __webpack_require__(155);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eio = __webpack_require__(161);
	...
	var Backoff = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 */
	module.exports.parser = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseuri = __webpack_require__(145);
	var parsejson = __webpack_require__(189);
	var parseqs = __webpack_require__(180);
	...
	Socket.Transport = __webpack_require__(169);
	Socket.transports = __webpack_require__(164);
	Socket.parser = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XHR = __webpack_require__(167);
	var JSONP = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(179);
	var inherit = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transport = __webpack_require__(169);
	var parseqs = __webpack_require__(180);
	var parser = __webpack_require__(170);
	var inherit = __webpack_require__(181);
	var yeast = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (typeof window === 'undefined') {
	  try {
	    NodeWebSocket = __webpack_require__(187);
	  } catch (e) { }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageList = function (_React$Component) {
	    (0, _inherits3.default)(MessageList, _React$Component);
